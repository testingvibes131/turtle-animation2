      ...
      <div className="mx-auto flex w-full max-w-[1440px] flex-1 flex-col px-6 md:px-10 lg:px-[60px]">
        <div className="w-full flex-1 pt-[15svh]">
          <RevealOnScroll className="flex w-full flex-col">
            <h1 className="w-full overflow-visible bg-clip-text pb-[0.075em] text-7xl font-normal leading-none tracking-[0.4px] text-transparent text-gradient-heading">
              Onchain Yield Management
            </h1>
              <p className="bg-clip-text text-3xl font-normal leading-[1.3] text-transparent text-gradient-heading">
                Aggregated, Diligenced, Personalized
              </p>
              <div className="pointer-events-auto inline-flex gap-2 mt-6">
