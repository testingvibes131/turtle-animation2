...
export function DeFiCta() {
  return (
    ...
    >
      ...
      <RevealOnScroll className="w-full text-left max-lg:max-w-full lg:max-w-none lg:flex-1">
        <SectionIntro className="max-w-none items-start lg:max-w-[36rem]">
          <p className="bg-clip-text text-[clamp(17px,1.6vw,24px)] font-normal leading-[1.4] text-transparent text-gradient-heading-h">
            DeFi promised an upgrade. It delivered a mess. Turtle is the upgrade
