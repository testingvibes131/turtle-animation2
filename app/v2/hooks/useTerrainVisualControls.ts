...
export function useTerrainVisualControls(): TerrainVisualParams {
  ...
  const depthFade = useControls("Depth fade", {
    ...
    markerCloseNear: {
      value: d.depthFadeCloseNearScale,
      min: 0.15,
      max: 1.2,
      step: 0.05,
      label: "close inner × orbit min",
    },
    markerCloseFar: {
      value: d.depthFadeCloseFarScale,
      min: 0.8,
      max: 4,
      step: 0.1,
      label: "close outer × orbit min",
    },
    gridNear: {
  ...
  return useMemo(
    (): TerrainVisualParams => ({
      ...
      depthFadeCloseNearScale: depthFade.markerCloseNear,
      depthFadeCloseFarScale: depthFade.markerCloseFar,
