...
import type { CuratorDef } from "@/app/sketch/lib/curatorCatalog";
import { vertexDirection } from "@/app/sketch/lib/frontHemisphere";
...
export function zoneHubCenterDot(frontMinDot: number, blobCenterLean = 0): number {
...
export function zoneHalfWidthDeg(frontMinDot: number, zoneCount: number): number {
