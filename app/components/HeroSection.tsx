  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex flex-col items-center gap-10">
        <h1
          id="hero-heading"
          className={`${montserrat.className} bg-gradient-to-r from-[#f9f9f9] to-[#8d928c] bg-clip-text text-center text-[clamp(1.75rem,5vw,2.5rem)] font-medium capitalize leading-[1.2] tracking-[-0.48px] text-transparent`}
        >
